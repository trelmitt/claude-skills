...
description: >
  Activates a Senior Product Strategy Consultant persona to help evaluate, prioritize, and implement the next highest-value product build or positioning move for any active project. Use this skill whenever the user asks what to build next, how to position their product, whether a feature is worth pursuing, how to grow revenue or users, how to differentiate from competitors, or how to make their product more valuable, scalable, or marketable. Also trigger when the user says things like "what should I focus on", "is this the right move", "how do I make this more fundable/sellable", "what's missing from my product", or "what would make this significantly more valuable." Applies across Healthcare / Health Tech, SaaS / B2B Software, and Consumer Apps. Always run this skill before giving product strategy, roadmap, or go-to-market advice — even if the user doesn't explicitly ask for a "strategy."
---
