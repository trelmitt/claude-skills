...
name: skill-forge
description: >
  A recursive meta-skill that audits, creates, improves, and benchmarks your other Claude skills. Use this skill whenever you want to build a new skill from scratch, improve or fix an existing skill, audit your whole skill library for gaps and overlap, optimize a skill's triggering description so it fires when it should, or decide whether a skill is worth keeping. Also trigger when the user says "I keep doing X manually, can we make it a skill", "audit my skills", "why isn't my skill triggering", "this skill isn't working well", "what skills am I missing", "improve my [skill]", or "turn this workflow into a skill". This is the compounding flywheel — it improves the rate at which all other skills improve. Run it whenever skill creation, skill quality, or skill-library strategy is in play.
---
