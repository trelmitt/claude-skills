...
description: >
  A deeply generative product ideation skill that acts as an elite sparring partner to help founders and PMs discover the most valuable next features, steps, and product directions. Use this skill whenever the user wants to brainstorm what to build next, expand a feature roadmap, explore new product directions, identify high-value opportunities, stress-test ideas, or asks anything like "what should I build next", "what am I missing", "what are the most valuable features I could add", "help me think through my roadmap", "what would make this product significantly more valuable", or "I need product ideas for X". This skill is project-agnostic — it works across any product, domain, or stage. Always trigger for any open-ended product ideation request, even if the user doesn't explicitly say "brainstorm" or "ideation." Run BEFORE feature-roadmap-builder.
---
